...
const ALL_NAV_ITEMS: NavItemConfig[] = [
    ...
    { id: 'relacionamento', icon: Handshake, label: 'Relac.', colorClass: { text: 'text-rose-600 dark:text-rose-400', bg: 'bg-rose-50 dark:bg-rose-900/30', dot: 'bg-rose-600 dark:bg-rose-400' } },
    ...
    { id: 'relacionamento_fornecedores', icon: Handshake, label: 'Forn.', colorClass: { text: 'text-teal-600 dark:text-teal-400', bg: 'bg-teal-50 dark:bg-teal-900/30', dot: 'bg-teal-600 dark:bg-teal-400' } },
    { id: 'clientes', icon: Users, label: 'Clientes', colorClass: { text: 'text-blue-600 dark:text-blue-400', bg: 'bg-blue-50 dark:bg-blue-900/30', dot: 'bg-blue-600 dark:bg-blue-400' } },
    { id: 'fornecedores', icon: AddressBook, label: 'B. Fornec.', colorClass: { text: 'text-emerald-600 dark:text-emerald-400', bg: 'bg-emerald-50 dark:bg-emerald-900/30', dot: 'bg-emerald-600 dark:bg-emerald-400' } },
