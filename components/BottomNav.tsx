...
const ALL_NAV_ITEMS: NavItemConfig[] = [
    ...
    { id: 'relacionamento', icon: Handshake, label: 'R.CLIENTES', colorClass: { text: 'text-rose-600 dark:text-rose-400', bg: 'bg-rose-50 dark:bg-rose-900/30', dot: 'bg-rose-600 dark:bg-rose-400' } },
    { id: 'relacionamento_fornecedores', icon: Handshake, label: 'R.FORNEC', colorClass: { text: 'text-teal-600 dark:text-teal-400', bg: 'bg-teal-50 dark:bg-teal-900/30', dot: 'bg-teal-600 dark:bg-teal-400' } },
